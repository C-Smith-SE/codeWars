...
function happyCoding(nickname){
    ...
    const happy=words.includes('happy')
     const coding=words.includes('coding')
     if(!coding && !happy){
       return 5
     }
     else if(happy && !coding){
       return 4
     }
     else if(coding && !happy){
       return 3
     }
     else if(words.indexOf('happy') < words.indexOf('coding')){
       return 1
     }
     else{
       return 2
